    ...
    float3 calculateSpecular(in float4 albedo)
    {
        ...
        if(float(1) == 1) // Realistic
        {
            ...
            if(float(0))
            {
                ...
                finalSpecular += calculateNewSpecular(specularMap.rgb, float(1), realisticAlbedo, float4(0.03310475,0.03310475,0.03310475,1), metallic, float(0.75) * specularMap.a, poiLight.dotNH, poiLight.dotLH, poiLight.color, attenuation);
            #else
                finalSpecular += calculateNewSpecular(specularMap.rgb, float(1), realisticAlbedo, float4(0.03310475,0.03310475,0.03310475,1), metallic, float(0.75) * specularMap.a, poiLight.dotNH, poiLight.dotLH, poiLight.color, poiLight.attenuation);
            #endif
        }
        ...
        if(float(1) == 4)
        {
            ...
            if (float(1) == 3) // anisotropic
            {
                ...
                finalSpecular += AnisotropicSpecular(float(0), float(0), float(0.75), float(0), float(1), float(1), float4(0.03310475,0.03310475,0.03310475,1), metallic, specularMap, poiLight.color, poiLight.direction, poiLight.halfDir, poiLight.nDotL, jitter, packedTangentMap, albedo);
                finalSpecular *= float4(0.03310475,0.03310475,0.03310475,1);
                finalSpecular *= attenuation;
            }
        #endif
        ...
        if (float(0))
        {
            ...
            if(float(1) == 1) // Realistic
            {
                ...
                #ifdef FORWARD_BASE_PASS
                    finalSpecular1 = calculateNewSpecular(specularMap1.rgb, float(1), realisticAlbedo1, float4(0.03310475,0.03310475,0.03310475,1), metallic1, float(0.75) * specularMap1.a, poiLight.dotNH, poiLight.dotLH, poiLight.color, saturate(poiLight.nDotL));
                #else
                    finalSpecular1 = calculateNewSpecular(specularMap1.rgb, float(1), realisticAlbedo1, float4(0.03310475,0.03310475,0.03310475,1), metallic1, float(0.75) * specularMap1.a, poiLight.dotNH, poiLight.dotLH, poiLight.color, poiLight.attenuation);
                #endif
            }
            ...
            if (float(1) == 3) // anisotropic
            {
                ...
                finalSpecular1 = AnisotropicSpecular(float(0), float(0), float(0.75), float(0), float(1), float(1), float4(0.03310475,0.03310475,0.03310475,1), metallic1, specularMap1, poiLight.color, poiLight.direction, poiLight.halfDir, poiLight.nDotL, jitter, packedTangentMap, albedo);
                finalSpecular1 *= float4(0.03310475,0.03310475,0.03310475,1);
                finalSpecular1 *= poiLight.attenuation;
            }
